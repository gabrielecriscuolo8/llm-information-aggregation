...
class MockClient:
    ...
    def complete_forecast(self, system: str, user: str, seed: int) -> Completion:
        ...
        if task == "central_update":
        ...
        elif task == "private_forecast":
            signal = context["private_signal"]
            ...
            reason = "Rational mock posterior from the single private signal."
        elif task == "market_trade":
            signal = context["private_signal"]
            probability = bayesian_posterior(
            ...
            probability = min(
                max(probability, float(context["forecast_min_probability"])),
                float(context["forecast_max_probability"]),
            )
            reason = "Rational mock update of public market odds with the private signal."
        else:
